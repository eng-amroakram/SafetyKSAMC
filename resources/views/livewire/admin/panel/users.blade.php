<div class="container-fluid">
    <div class="p-4 mb-4">
        ...
        <div class="row mb-4" wire:ignore>
            @livewire('partials.page-header', ['title' => 'الموظفين', 'label' => 'موظف', 'model' => false, 'user' => false, 'perm' => true])
        </div>
            ...
            <table class="table table-bordered text-center" style="margin-bottom: 0rem;">
                <thead>
                    <tr>
                        ...
                        <th data-mdb-sort="false" class="th-sm"><strong>المسمى الوظيفي</strong></th>
                        <th data-mdb-sort="false" class="th-sm"><strong>الرقم الوظيفي</strong></th>
                        <th data-mdb-sort="false" class="th-sm"><strong>رقم الهوية</strong></th>
